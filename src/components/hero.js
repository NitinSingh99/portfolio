  ...
  hero.innerHTML = `
    <div id="hero-section" class="relative">
          <div
            ...
            <div class="flex flex-col items-start">
              ...
              <div class="lg:hidden hero-icons px-0 lg:px-16">
                <div class="mt-2 flex gap-6"><a class="group -m-1 p-1" aria-label="Follow on X" href="#"><svg
                      ...
                      class="h-4 w-4 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
                      <path
            ...
            <div class="relative px-4 py-16 lg:p-6 overflow-visible">
              <div class="pointer-events-none absolute inset-0">
                <div
                  class="absolute top-7 -left-1 lg:-top-12 lg:-left-14 text-xl md:text-2xl lg:text-7xl text-teal-400 opacity-30 dark:opacity-20 animate-float-slow">
                  { }</div>
                <div
                  class="absolute bottom-7 -right-1 lg:-bottom-12 lg:-right-12 text-xl md:text-2xl lg:text-5xl text-cyan-400 opacity-30 dark:opacity-20 animate-float-medium">
                  &lt;/&gt;
                </div>
              </div>

              
              <div class="w-65 md:w-120 lg:w-95 relative z-10">
                <div class="
                ...
                ">
                  ...
                  <!-- Code area -->
                  <div class="
                      p-6 font-mono text-xs md:text-sm lg:text-sm
                      text-zinc-800 dark:text-zinc-300
                      bg-transparent
                      overflow-hidden
                    ">
                    <code id="code-display" class="block"></code>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div class="hidden lg:block hero-icons px-4 lg:px-16">
